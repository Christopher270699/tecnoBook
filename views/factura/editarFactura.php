    ...
    <form id="MyForm" action="<?php echo URL; ?>factura/actualizarFactura" method="POST" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-xs-4">
                    <input type="text" class="form-control input-sm validate[required]"  id="txt_nombreLibro" name="txt_nombreLibro" value='<?php echo $this->datosFactura[0]['nombreLibro']; ?>'/>
                </div>
                <label for="txt_nombreEstudiante" class="col-xs-2 control-label">Nombre del Estudiante:</label>
                <div class="col-xs-4">
                    <input type="text" class="form-control input-sm"  id="txt_nombreEstudiante" name="txt_nombreEstudiante" value='<?php echo $this->datosFactura[0]['nombreEstudiante']; ?>'/>
                </div>    
            </div>
            <div class="form-group">
                <label for="txt_fechaPedido" class="col-xs-2 control-label">Fecha del Pedido:</label>
                <div class="col-xs-4">
                    <input type="text" class="form-control input-sm validate[required]"  id="txt_fechaPedido" name="txt_fechaPedido" value='<?php echo $this->datosFactura[0]['fechaPedido']; ?>'/>
                </div>
