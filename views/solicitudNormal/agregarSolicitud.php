...
?>
<div class="row">
    <form id="MyForm" action="<?php echo URL; ?>solicitudNormal/guardarSolicitud" method="POST" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
            <legend class="text-center">Agregar Solicitud</legend>
